...
from model.faster_rcnn_2s_hf.resnet_twostage import resnet
...
def parse_args():
  ...
  parser.add_argument('--cfg', dest='cfg_file',
                      help='res101.yml',
                      default='cfgs/personpart_2s/res50_ms_hf.yml', type=str)
...
if __name__ == '__main__':
  ...
  for epoch in range(args.start_epoch, cfg.TRAIN.EPOCHS + 1):
    ...
    for step in range(iters_per_epoch):
      ...
      # # im2show_2fc = vis_rois(im2show_2fc, boxes_handface.cpu().numpy(), rois_label_hf.data.cpu().numpy(), person_flag=0)
      # # cv2.imwrite('./debug/' + str(step) + '_2s_strong.png', im2show_2fc)
      #
      ...
      # # im2show_2fc = vis_rois(im2show_2fc, pred_boxes_hf.view(-1, pred_boxes_hf.size(2)).cpu().numpy(), rois_label_hf.data.cpu().numpy(), person_flag=0)
      # # cv2.imwrite('./debug_rcnn/' + str(step) + '_2s_strong.png', im2show_2fc)
      # # # ######################## debug ########################
