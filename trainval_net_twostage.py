...
if __name__ == '__main__':
  ...
  stage2_params = get_trainable_param(fasterRCNN, 'RCNN_conv_new_hf,RCNN_rpn_handface,RCNN_2fc_hf,RCNN_bbox_pred_handface,RCNN_cls_score_handface')
  ...
  for epoch in range(args.start_epoch, cfg.TRAIN.EPOCHS + 1):
    ...
    for step in range(iters_per_epoch):
      ...
      # cv2.imwrite('./debug/' + str(step) + '_2fc.png', im2show_2fc)
      ...
      # cv2.imwrite('./debug_rcnn/' + str(step) + '_2fc.png', im2show_2fc)
      # # # ######################## debug ########################
