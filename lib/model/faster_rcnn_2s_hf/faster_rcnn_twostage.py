...
from model.rpn_2s_hf.rpn import _RPN
from model.roi_pooling.modules.roi_pool import _RoIPooling
from model.roi_crop.modules.roi_crop import _RoICrop
from model.roi_align.modules.roi_align import RoIAlignAvg
from model.rpn_2s_hf.proposal_target_layer_cascade import _ProposalTargetLayer

from model.rpn_2s_hf.bbox_transform import clip_boxes, clip_boxes_batch
from model.rpn_2s_hf.bbox_transform import bbox_transform_inv, bbox_transform_batch
...
class _fasterRCNN(nn.Module):
    ...
    def __init__(self, classes, class_agnostic):
        ...
        self.RCNN_rpn_handface = _RPN(256, person_flag=0)

        self.RCNN_proposal_target = _ProposalTargetLayer(3)
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes):
        ...
        new_feat = self.RCNN_conv_new(top_feat)
        new_feat_hf = self.RCNN_conv_new_hf(top_feat)
        top_feat_hf = self.RCNN_top_hf(new_feat_hf)
        ...
        # if cfg.POOLING_MODE == 'align':
        #     pooled_feat_handface = self.RCNN_roi_align_hf(top_feat_hf, rois_handface.view(-1, 5))
        # elif cfg.POOLING_MODE == 'pool':
        #     pooled_feat_handface = self.RCNN_roi_pool_hf(top_feat_hf, rois_handface.view(-1, 5))
        #
