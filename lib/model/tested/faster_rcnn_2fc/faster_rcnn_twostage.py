...
class _fasterRCNN(nn.Module):
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes):
        ...
        top_feat = self.RCNN_top(base_feat) # batch_size * 2048 * h * w
        new_feat = self.RCNN_conv_new(top_feat) # batch_size * 256 * h * w
        new_feat_hf = self.RCNN_conv_new_hf(top_feat)  # batch_size * 256 * h * w
