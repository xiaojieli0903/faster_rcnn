...
if __name__ == '__main__':
  ...
  for epoch in range(args.start_epoch, cfg.TRAIN.EPOCHS + 1):
    ...
    for step in range(iters_per_epoch):
      ...
      # im2show_2s_origin = im.data.cpu().numpy()
      ...
      # im2show_2s_origin = vis_rois(im2show_2s_origin, boxes_handface.cpu().numpy(), rois_label_hf.data.cpu().numpy(), person_flag=0)
      # cv2.imwrite('./debug/' + str(step) + '_2s_origin.png', im2show_2s_origin)
      ...
      # im2show_2s_origin = vis_rois(im2show_2s_origin, pred_boxes_hf.view(-1, pred_boxes_hf.size(2)).cpu().numpy(), rois_label_hf.data.cpu().numpy(), person_flag=0)
      # cv2.imwrite('./debug_rcnn/' + str(step) + '_2s_origin.png', im2show_2s_origin)
      # ######################## debug ########################
