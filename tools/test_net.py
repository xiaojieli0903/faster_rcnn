...
def parse_args():
  ...
  parser.add_argument('--cfg', dest='cfg_file',
                      ...
                      default='cfgs/personpart/res101.yml', type=str)
  ...
  parser.add_argument('--load_dir', dest='load_dir',
                      help='directory to load models', default="/mnt/lvmhdd/xiaojiework/faster-rcnn/baseline/models",
                      type=str)
...
if __name__ == '__main__':
  ...
  if args.dataset == "pascal_voc":
      ...
      # args.set_cfgs = ['ANCHOR_SCALES', '[2, 4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
      args.set_cfgs = []
  ...
  for i in range(num_images):
      ...
      for j in xrange(1, imdb.num_classes):
          ...
          if inds.numel() > 0:
            ...
            if vis:
              im2show = vis_detections(im2show, imdb.classes[j], cls_dets.cpu().numpy(), thresh)
      ...
      output_dir = cfg.LOAD_DIR + '/' + args.out_dir
      det_file = os.path.join(output_dir, 'detections.pkl')
