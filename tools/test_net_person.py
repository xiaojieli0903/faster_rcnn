...
from model.faster_rcnn_person.vgg16 import vgg16
from model.faster_rcnn_person.resnet_person import resnet
import pdb
...
def parse_args():
    ...
    parser.add_argument('--cfg', dest='cfg_file',
                        help='res101.yml',
                        default='cfgs/personpart_person/res101.yml', type=str)
...
if __name__ == '__main__':
    ...
    if args.dataset == "pascal_voc":
        ...
        # args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'ANCHOR_SCALES_person',
    ...
    input_dir = cfg.SAVE_DIR + "/" + args.dataset + "/" + cfg.EXP_DIR
    ...
    for i in range(num_images):
        ...
        if args.test_mode == 'all':
            output_dir = input_dir + '/output_all'
        if args.test_mode == '1s':
            output_dir = input_dir + '/output_1s'
        if args.test_mode == '2s':
            output_dir = input_dir + '/output_2s'
