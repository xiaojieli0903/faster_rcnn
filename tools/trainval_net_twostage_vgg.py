...
def parse_args():
  ...
  parser.add_argument('--cfg', dest='cfg_file',
                      help='res101.yml',
                      default='cfgs/personpart_2s/vgg16.yml', type=str)
...
if __name__ == '__main__':
  ...
  stage1_params = get_trainable_param(fasterRCNN, 'RCNN_rpn,RCNN_bbox_pred,RCNN_cls_score')
  stage2_params = get_trainable_param(fasterRCNN, 'RCNN_rpn_handface,RCNN_bbox_pred_handface,RCNN_cls_score_handface')
